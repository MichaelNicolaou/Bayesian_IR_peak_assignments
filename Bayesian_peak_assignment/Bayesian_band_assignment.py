...
Molecule_list = ['Hydroxybenzaldehyde']
path = ''
...
for Molecule in Molecule_list:
    ...
    if Molecule == 'Hydroxybenzaldehyde':
        Threshold = 45
    ...
    if Molecule == 'Hydroxybenzaldehyde':
        for wavenumber in range(0, len(df_exp.loc[:, "Frequency"])):
            if df_exp.loc[wavenumber, "dt-1"] <= 0 and df_exp.loc[wavenumber, "dt+1"] > 0 and df_exp.loc[wavenumber, "dt-10"] < 0.01 and df_exp.loc[wavenumber, "dt+10"] > 0.01 and df_exp.loc[wavenumber, "Frequency"] > 680 and df_exp.loc[wavenumber, "Frequency"] < 1800 and str(df_exp.loc[wavenumber, "Observation"]) != "Noise":
